...
- Add the application in your [ezmaster](https://github.com/Inist-CNRS/ezmaster) ([cnrsinist/ezs-playground:2.0.0](https://hub.docker.com/r/cnrsinist/ezs-playground/2.0.0/)) then create a new instance
